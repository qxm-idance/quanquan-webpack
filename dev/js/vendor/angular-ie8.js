 ...
 */ (function(window, document, undefined) {
    ...
    function minErr(module) {
        return function() {
            ...
            message = message + '\nhttp://errors.angularjs.org/1.2.27/' + (module ? module + '/' : '') + code;
    ...
    function bootstrap(element, modules) {
        var doBootstrap = function() {
            ...
            if (element.injector()) {
                ...
                throw ngMinErr('btstrpd', "App Already Bootstrapped with this Element '{0}'",
                    tag.replace(/</, '<').replace(/>/, '>'));
            }
            ...
            function($injector, $interpolate, $exceptionHandler, $http, $templateCache, $parse,
                ...
                function groupScan(node, attrStart, attrEnd) {
                    ...
                    if (attrStart && node.hasAttribute && node.hasAttribute(attrStart)) {
                        ...
                        do {
                            if (!node) {
                                throw $compileMinErr('uterdir', "Unterminated attribute, found '{0}' but no matching '{1}' found.",
                                    attrStart, attrEnd);
                            }
                ...
                function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
                    ...
                    function getControllers(directiveName, require, $element, elementControllers) {
                        ...
                        if (isString(require)) {
                            ...
                            if (!value && !optional) {
                                throw $compileMinErr('ctreq', "Controller '{0}', required by directive '{1}', can't be found!",
...
// });
    ...
    function ensureSafeObject(obj, fullExpression) {
        ...
        if (obj) {
            if (obj.constructor === obj) {
                ...
                throw $parseMinErr('isecwindow', 'Referencing the Window in Angular expressions is disallowed! Expression: {0}',
                    fullExpression);
            } else if ( // isElement(obj)
                obj.children && (obj.nodeName || (obj.prop && obj.attr && obj.find))) {
                throw $parseMinErr('isecdom', 'Referencing DOM nodes in Angular expressions is disallowed! Expression: {0}',
                    fullExpression);
            } else if ( // block Object so that we can't get hold of dangerous Object.* methods
                obj === Object) {
                throw $parseMinErr('isecobj', 'Referencing Object in Angular expressions is disallowed! Expression: {0}',
                    fullExpression);
            }
        }
        return obj;
    ...
    Parser.prototype = {
        ...
        throwError: function(msg, token) {
            throw $parseMinErr('syntax', 'Syntax Error: Token \'{0}\' {1} at column {2} of the expression [{3}] starting at [{4}].',
        ...
        this.$get = ['$injector', function($injector) {
            ...
            function trustAs(type, trustedValue) {
                ...
                if (typeof trustedValue !== 'string') {
                    throw $sceMinErr('itype', 'Attempted to trust a non-string value in a content requiring a string: Context: {0}',
                        type);
                }
            ...
            if (match) {
                ...
                patternValidator = function(value) {
                    ...
                    if (!patternObj || !patternObj.test) {
                        throw minErr('ngPattern')('noregexp', 'Expected {0} to be a RegExp but was {1}. Element: {2}', pattern,
                ...
                $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
                    ...
                    for (index = 0; index < length; index++) {
                        ...
                        if (lastBlockMap.hasOwnProperty(trackById)) {
                            ...
                            throw ngRepeatMinErr('dupes', "Duplicates in a repeater are not allowed. Use 'track by' expression to specify unique keys. Repeater: {0}, Duplicate key: {1}, Duplicate value: {2}",
 ...
 * }
    ...
    var ngTranscludeDirective = ngDirective({
        link: function($scope, $element, $attrs, controller, $transclude) {
            if (!$transclude) {
                throw minErr('ngTransclude')('orphan', 'Illegal use of ngTransclude directive in the template! ' + 'No parent directive that requires a transclusion found. ' + 'Element: {0}',
                    startingTag($element));
            }
            ...
            link: function(scope, element, attr, ctrls) {
                ...
                function setupAsOptions(scope, selectElement, ctrl) {
                    ...
                    if (!(match = optionsExp.match(NG_OPTIONS_REGEXP))) {
                        throw ngOptionsMinErr('iexp', "Expected expression in form of " + "'_select_ (as _label_)? for (_key_,)?_value_ in _collection_'" + " but got '{0}'. Element: {1}",
